...
function initTextures() {
  loadTexture('jellyfish', '/jellyfish/images/jellyfish.png');
  loadTexture('luminescence', '/jellyfish/images/luminescence.png');

  for (var i=1; i <= 32; i++) {
    loadTexture('caustics'+i, '/jellyfish/images/caustics/caustics7.'+pad2(i-1)+'.jpg');
  }
}
